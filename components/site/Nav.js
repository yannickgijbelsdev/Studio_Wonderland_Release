...
const WORLDS = {
  show: {
    ...
    pill: 'bg-show-reddeep/90 border border-show-gold/25',
  ...
  xmas: {
    ...
    pill: 'bg-xmas-green/90 border border-xmas-gold/25',
...
export default function Nav() {
  const { route } = useSite()
  if (route === 'show' || route === 'xmas') return <WorldNav route={route} />
  return <MainNav />
}
