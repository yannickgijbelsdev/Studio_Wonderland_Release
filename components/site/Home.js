  ...
  return (
    ...
    >
      ...
      <div className="relative flex h-full flex-col justify-end p-8 md:p-10">
        ...
        <p className="mt-4 max-w-md text-white/80">{desc}</p>
    ...
    <div ref={scope}>
      ...
      <section className="hero-sec relative h-[100svh] w-full overflow-hidden">
        ...
        <div className="relative z-10 flex h-full flex-col items-center justify-center px-6 text-center">
          <div className="overflow-hidden"><span className="hero-sub block text-xs uppercase tracking-[0.5em] text-wonder-pink">Studio Wonderland presenteert</span></div>
          <h1 className="mt-6 font-display text-[15vw] font-500 leading-[0.85] text-white md:text-[9vw]">
          ...
          <div className="mt-8 max-w-2xl overflow-hidden">
            <p className="hero-sub text-lg text-white/90 md:text-2xl">Wij maken werelden waar families samen in kunnen stappen.</p>
          </div>
        </div>
        <div className="hero-cue absolute bottom-8 left-1/2 z-10 flex -translate-x-1/2 flex-col items-center gap-2 text-white/70">
        ...
        <div className="mx-auto max-w-[1400px]">
          <div className="mb-14 flex flex-col items-start justify-between gap-6 md:flex-row md:items-end">
            <div>
              ...
              <h2 className="mt-5 font-display text-4xl leading-tight text-wonder-ink md:text-6xl">
      ...
      <section className="relative overflow-hidden px-6 py-24 md:px-10 md:py-36">
        <div className="mx-auto grid max-w-[1400px] items-center gap-14 md:grid-cols-2">
          <div>
            ...
            <div data-fade className="mt-10 grid grid-cols-3 gap-6 border-t border-wonder-gold/20 pt-8">
          ...
          <div className="relative">
            ...
            <div data-parallax="0.15" className="absolute -bottom-10 -left-8 hidden w-48 overflow-hidden rounded-xl border border-white/40 shadow-xl md:block">
      ...
      <section className="relative px-6 pb-28 md:px-10">
        <div className="mx-auto max-w-[1400px] overflow-hidden rounded-3xl border border-wonder-gold/25 bg-wonder-panel p-10 text-center md:p-20">
