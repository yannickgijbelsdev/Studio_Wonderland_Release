...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        wonder: { bg: '#FCE7EE', blush: '#FBDCE7', rose: '#F6C9D8', panel: '#F8D5E0', pinklt: '#F4B8CB', pink: '#E098A8', pinkdeep: '#C04868', plum: '#7D2540', cream: '#FFF6F9', ink: '#3B1622', muted: '#9A6576', gold: '#C04868', goldlight: '#E098A8' },
        show: { bg: '#140306', panel: '#1e070b', red: '#E11D2A', reddeep: '#8E0E17', gold: '#F2C24B', cream: '#FCE9D0' },
        xmas: { bg: '#07130E', panel: '#0C2019', green: '#0E3B2E', gold: '#EBC474', red: '#C4462F', cream: '#F3EEDC' },
